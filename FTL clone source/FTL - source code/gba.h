...
#define ATTR2_ID8_MASK       ATTR2_ID8(0x2FF) //added define for setid function
...
static inline void SetObjectID(int object, int id) //added function used to change OBJ ID
{
	ObjAttr& obj(ObjBuffer[object]);
	obj.attr2 = (obj.attr2 & ~ATTR2_ID8_MASK) | ATTR2_ID8(id);
}
